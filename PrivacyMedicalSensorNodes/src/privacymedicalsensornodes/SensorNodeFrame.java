        ...
        {  		
			...
			// Actual splitting of file into smaller files  
                ...
                {  
                    ...
                    FileWriter fstream1 = new FileWriter("C:\\Users\\nikit\\Downloads\\Secured\\PrivacyMedicalSensorNodes\\FILE"+fi+""+j+".txt");     // Destination File Location  
                    if(!(path.contains("C:\\Users\\nikit\\Downloads\\Secured\\PrivacyMedicalSensorNodes\\FILE"+fi+""+j+".txt")))
                    {
                        path.add("C:\\Users\\nikit\\Downloads\\Secured\\PrivacyMedicalSensorNodes\\FILE"+fi+""+j+".txt");
                    }
